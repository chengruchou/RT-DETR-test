...
# === 你的參數 ===
coco_path = r'D:\Code\RT-DETR-test\raw_dataset\MOBDrone_videos\annotations_person_coco_classes.json'
images_dir = r'D:\Code\RT-DETR-test\MOBDRONE_split_dataset\all'
